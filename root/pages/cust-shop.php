    ...
    <section class="shop-container">
        <div class="shop-content">
            <div class="shop-box">
                ...
                <h2 class="shop-product-title">Small Box One</h2>
            ...
            <div class="shop-box">
                <img src="../images/box.png" class="shop-img">
                <h2 class="shop-product-title">Small Box Two</h2>
            ...
            <div class="shop-box">
                <img src="../images/box.png" class="shop-img">
                <h2 class="shop-product-title">Small Box Three</h2>
            ...
            <div class="shop-box">
                <img src="../images/box.png" class="shop-img">
                <h2 class="shop-product-title">Small Box Four</h2>
            ...
            <div class="shop-box">
                <img src="../images/box.png" class="shop-img">
                <h2 class="shop-product-title">Small Box Five</h2>
            ...
            <div class="shop-box">
                <img src="../images/box.png" class="shop-img">
                <h2 class="shop-product-title">Small Box Six</h2>
            ...
            <div class="shop-box">
                <img src="../images/box.png" class="shop-img">
                <h2 class="shop-product-title">Small Box Seven</h2>
            ...
            <div class="shop-box">
                <img src="../images/box.png" class="shop-img">
                <h2 class="shop-product-title">Small Box Eight</h2>
            ...
            <div class="shop-box">
                <img src="../images/box.png" class="shop-img">
                <h2 class="shop-product-title">Small Box Nine</h2>
            ...
            <div class="shop-box">
                <img src="../images/box.png" class="shop-img">
                <h2 class="shop-product-title">Small Box Ten</h2>

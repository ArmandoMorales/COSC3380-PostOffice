    ...
    <section class="side-bar-container">
        ...
        <div class="content">
            <?php
                ...
                $priority = $_POST['prio'];
                $priorityConverted = (int) $priority;
                ...
                mysqli_stmt_bind_param($stmtPkg, "isddiiii", $_SESSION["userid"], $ptype, $weight, $vol_converted, $holdRaddr,$holdDaddr, $notReceived, $priority);

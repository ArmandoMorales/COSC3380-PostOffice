    ...
    <section class="side-bar-container">
        ...
        <div class="content">
            ...
            <div class="form-col">
                ...
                <input type="text" name="lname" placeholder="Enter your destination">
                ...
                <input type="text" name="address" placeholder="Enter state">
                ...
                <input type="text" name="phone-number" placeholder="Enter zip">
                ...
                <input type="text" name="phone-number" placeholder="Enter package weight">
                ...
                <input type="text" name="phone-number" placeholder="Enter package volume">

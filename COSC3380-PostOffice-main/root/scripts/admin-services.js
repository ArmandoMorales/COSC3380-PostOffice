...
function sideBarButtonClicked(event) {
    ...
    }else if (event.target.innerText == "Create New Employee") {
        createNewEmployee();
    }else if (event.target.innerText == "Add Employee Permissions") {
        createAddPerms();
    }else if (event.target.innerText == "Remove Employee Permissions") {
        createRemovePerms();
    }else if (event.target.innerText == "Create New Post Office") {
        createPostOffice();
    }
}
...
//Manager
//This is for creating new employees
function createNewEmployee(){
    ...
    // now listen for when submit button is clicked
    var empSubmitButton = document.getElementById('emp-add-emp-btn');
    empSubmitButton.addEventListener('click', empCreateButtonClicked);
}

//This runs when it is clicked, what it will do, I don't know yet
function empCreateButtonClicked(event){
    
}


//ADMIN
//This is for adding an employee to the manager or administrator tables
function createAddPerms(){
    // BE CAREFUL: if you have multiple forms (form-col classes) in one of the side bar options, this won't grab all of them.
    // a soltuion using getElementById will probably be necessary.
    var oldFormContent = document.getElementsByClassName('form-col')[0];
    oldFormContent.remove();
    ...
    var formContent = `
                    ...
                    <button type="submit" class="hero-btn red-btn" id="adm-cng-perm-btn">Choose Employee</button>
    ...
    // now listen for when submit button is clicked
    var empSubmitButton = document.getElementById('adm-cng-perm-btn');
    empSubmitButton.addEventListener('click', adminPermAdd);
}

function adminPermAdd(event){
        // BE CAREFUL: if you have multiple forms (form-col classes) in one of the side bar options, this won't grab all of them.
    // a soltuion using getElementById will probably be necessary.
    var oldFormContent = document.getElementsByClassName('form-col')[0];
    oldFormContent.remove();
    ...
    var formContent = `
                    ...
                    <button type="submit" class="hero-btn red-btn" id="adm-cng-perm-btn">Update Permissions</button>
    ...
    // now listen for when submit button is clicked
    var empSubmitButton = document.getElementById('adm-cng-perm-btn');
    empSubmitButton.addEventListener('click', adminPermAddFinal);
}
function adminPermAddFinal(){

}

//ADMIN
//This is for "removing" the permisions of managers or administrators
function createRemovePerms(){
    // BE CAREFUL: if you have multiple forms (form-col classes) in one of the side bar options, this won't grab all of them.
    // a soltuion using getElementById will probably be necessary.
    var oldFormContent = document.getElementsByClassName('form-col')[0];
    oldFormContent.remove();
    ...
    // now listen for when submit button is clicked
    var empSubmitButton = document.getElementById('adm-cng-perm-btn');
    empSubmitButton.addEventListener('click', adminPermRem);
}
function adminPermRem(event){
        // BE CAREFUL: if you have multiple forms (form-col classes) in one of the side bar options, this won't grab all of them.
    // a soltuion using getElementById will probably be necessary.
    var oldFormContent = document.getElementsByClassName('form-col')[0];
    oldFormContent.remove();
    ...
    var formContent = `
                    ...
                    <input type="text" name="eID" placeholder="*******" required>
                    <p>Remove Manager Privileges</p>
                    <input type="checkbox" name="mTogg" value="Manager">
                    <p>Remove Administrator Privileges</p>
    ...
    // now listen for when submit button is clicked
    var empSubmitButton = document.getElementById('adm-cng-perm-btn');
    empSubmitButton.addEventListener('click', adminPermRemFinal);
}
function adminPermRemFinal(){

}

//ADMIN
//This is for createing a post office
function createPostOffice(){
    ...
    var formContent = `
                    ...
                    <i class="fa fa-user" aria-hidden="true"></i>
                    <span>
                        <h5>New Post Office Information</h5>
                    </span>
                    </div>
                    ...
                    <div>
                        <span>
                            <h2>Post Office Name</h2>
                        </span>
                    </div>
                    <input type="text" name="PoName" placeholder="Post Office" required>
                    ...
                    <input type="text" name="supID" placeholder="Supervisor ID (not strictly required)">
                    ...
                    <button type="submit" class="hero-btn red-btn" id="emp-add-emp-btn">Add Post Office</button>
    ...
    // now listen for when submit button is clicked
    var empSubmitButton = document.getElementById('emp-add-emp-btn');
    empSubmitButton.addEventListener('click', empCreatePOButtonClicked);
}

//This runs when it is clicked, what it will do, I don't know yet
function empCreatePOButtonClicked(event){
    //Generate Office ID
    //Generate package and employees to 0
    //If supervisor is set, add an employee and set start date to now
}
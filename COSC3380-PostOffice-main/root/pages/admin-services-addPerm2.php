...
<head>
    <?php
        ...
        $empTrue  = mysqli_stmt_get_result($stmt1);
        $empTrue = mysqli_fetch_all($empTrue);

        $sql2 = "SELECT count(*) FROM Employee as e, Employee as m WHERE e.Employee_ID = m.Super_ID and m.Super_ID = ?;";
        ...
        $mngTrue  = mysqli_stmt_get_result($stmt2);
        $mngTrue = mysqli_fetch_all($mngTrue);
    ?>
        ...
        <div class="content", id="EmpInfo">
            <div class="form-col">
                ...
                <span>
                    <h5>
                    <?php
                        echo "Contemplating Promotion for ";
                        echo $empTrue[0][0];
                        echo " ";
                        echo $empTrue[0][2];
                        echo "<br>";
                ...
                <form method="post" action="../pages/admin-services-addPerm2php">
                <div>
